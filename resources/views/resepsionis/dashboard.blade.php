    ...
    <div class="relative overflow-hidden rounded-xl bg-gradient-to-r from-emerald-600 to-teal-700 p-6 sm:p-8 text-white shadow-sm">
        <div class="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div class="flex items-center gap-3 shrink-0">
                <a href="{{ route('resepsionis.checkin.create') }}" class="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-white text-emerald-800 font-semibold text-sm hover:bg-emerald-50 shadow-sm transition-colors">

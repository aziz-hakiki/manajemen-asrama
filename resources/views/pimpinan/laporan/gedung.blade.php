                    ...
                    @forelse($gedungs as $gedung)
                        ...
                        <tr class="hover:bg-slate-50/80 transition-colors {{ (request('gedung_id') == $gedung->id) ? 'bg-indigo-50/40' : '' }}">
                            ...
                            <td class="px-6 py-4 text-right">
                                <a href="{{ $routeGedung }}?gedung_id={{ $gedung->id }}" class="inline-flex items-center gap-1 text-xs font-semibold text-indigo-600 hover:text-indigo-800 transition-colors">
    ...
    @if($selectedGedung)
        <div class="bg-white rounded-2xl border border-slate-200 shadow-xs overflow-hidden">
            <div class="p-5 border-b border-slate-100 flex items-center justify-between">
                ...
                <a href="{{ $routeGedung }}" class="text-xs text-slate-500 hover:text-slate-800 font-semibold">
                    &times; Tutup Rincian
                </a>
            </div>

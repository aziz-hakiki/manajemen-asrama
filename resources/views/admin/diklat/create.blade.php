<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-2 text-sm text-slate-500">
            ...
            <span>/</span>
            <span class="font-semibold text-slate-800">Tambah Diklat</span>
        </div>
    </x-slot>
    ...
    <div class="max-w-2xl">
        <div class="bg-white rounded-2xl border border-slate-200 shadow-xs p-6 sm:p-8">
            <div class="mb-6">
                <h2 class="text-lg font-bold text-slate-800">Tambah Program Diklat</h2>
                <p class="text-xs text-slate-500 mt-1">Masukkan nama program pelatihan dan jadwal pelaksanaannya.</p>
            </div>

            <form action="{{ route('admin.diklat.store') }}" method="POST" class="space-y-5">
                @csrf
                ...
                <div>
                    ...
                    <input 
                        ...
                        placeholder="Contoh: Diklat Kepemimpinan Tingkat IV Angkatan I"
                        required
